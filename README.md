# MiSnap SDK v5.10.0 for Android
...
Please see [versions.gradle](versions.gradle) and [libs.versions.toml](gradle/libs.versions.toml) for more details.
...
* When overriding the default locale in `MiSnapWorkflowActivity`, the content generated by the OS (e.g. permission dialogs, talkback contextual information, etc.) may use the system locale.
