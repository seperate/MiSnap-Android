# MiSnap SDK v5.10.0 for Android Supported Regions and Documents for NFC

# Table of Contents
[Regions with Full Support](#regions-with-full-support)

[Regions with Beta Support](#regions-with-beta-support)
...
| Region                   | Document                                               |
|--------------------------|--------------------------------------------------------| 
| Belgium                  | ID<br>Driver's License<br>Passport<br>Residence Permit |
| France                   | ID<br>Driver's License<br>Passport<br>Residence Permit |
| Italy                    | ID<br>Driver's License<br>Passport<br>Residence Permit |
| Ireland                  | ID<br>Passport                                         |
| Netherlands              | ID<br>Driver's License<br>Passport<br>Residence Permit |
| Spain                    | ID<br>Driver's License<br>Passport<br>Residence Permit |
| United Kingdom           | ID<br>Passport                                         |
| United States of America | Passport                                               |

- - - -

# Regions with Beta Support

| Region                 | Document                           |
|------------------------|------------------------------------| 
| Albania                | ID<br>Passport                     |
| Algeria                | Passport                           |
| Argentina              | Passport                           |
| Australia              | Passport                           |
| Austria                | Passport<br>Residence Permit       |
| Azerbaijan             | Passport                           |
| Bahamas                | Passport                           |
| Bangladesh             | Passport                           |
| Belarus                | ID<br>Passport                     |
| Bosnia and Herzegovina | ID<br>Passport                     |
| Brazil                 | Passport                           |
| Bulgaria               | Passport<br>Residence Permit       |
| Cameroon               | Passport                           |
| Canada                 | Passport<br>Residence Permit       |
| Chile                  | ID<br>Passport<br>Residence Permit |
| China                  | Passport                           |
...
| Slovenia               | Passport<br>Residence Permit<br>ID |
